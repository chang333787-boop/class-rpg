...
> **언제**: Firebase 규칙 게시 → PR #214(마을 53차 서버용) 머지 → GitHub Pages 배포가 끝난 **직후 한 번.**
...
| 배포된 마을이 53차 서버용이다 | `curl -s https://funclassrpg.kr/village/index.html \| sha256sum` | `a9a10b6f…` 로 시작 |
