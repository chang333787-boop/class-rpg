...
| 그림 | 쓰임 |
|---|---|
| `heart_full` · `heart_empty` (40×40) | 동물 카드의 하트 칸(다음 단계까지 3·5·7·10 — 아래 절) |
...
![동물 카드 — 하트 칸 3·5·7·10 · 새 선물 · 사진 틀](img/deco_guests_art_20260924/cards_hearts_gifts_photo.png)

- **하트 칸 = 다음 단계까지 필요한 수**: 처음 만남 3 · 알아봄 5 · 친구 7 · 단짝 10 (문턱 0/3/8/15/25 · 보스 확정). 가족(5단계)은 칸을 보이지 않는다.
  - 7칸까지는 한 줄에 `heart_*` 22px(7칸은 18px) · 10칸은 **다섯씩 두 줄**(18px).
