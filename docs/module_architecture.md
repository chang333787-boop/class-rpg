...
class-rpg/
  ...
  gamedata.js  (2,828줄) # 공통: GAME_DATA 상수 + DB 레이어 + Utils + 정규화
  student.js  (10,127줄) # 학생 기능 전체 (가장 큼)
  admin.js     (5,462줄) # 관리 기능 전체 (탭별 render)
  kiosk.js       (753줄) # 키오스크 기능 (가장 작고 경계 뚜렷)
  *.css × 3              # 화면별 스타일
  scripts/
...
- **현재 기대 기준선**: verify-safety = PASS 18 · REVIEW 1 · FAIL 0, smoke-test = PASS 27 · REVIEW 0 · FAIL 0. FAIL 발생 또는 기준선 이탈 시 중단·보고.
