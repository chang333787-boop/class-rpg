...
const GAME_DATA = {
  ...
  decorations: [
    ...
    {id:'d_y55',name:'닭 한 마리',    icon:'🐔', priceAdj:-30, cat:'yard', rarity:'rare',   reqLv:1},
    {id:'d_y56',name:'오리 한 마리',  icon:'🦆', priceAdj:-30, cat:'yard', rarity:'rare',   reqLv:1},
    {id:'d_y57',name:'양 한 마리',    icon:'🐑', priceAdj:-30, cat:'yard', rarity:'rare',   reqLv:1},
    // ── 집 안 (indoor) ──
    // ⚪ 일반 Lv1+
