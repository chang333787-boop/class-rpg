...
const GAME_DATA = {
  ...
  decorations: [
    ...
    {id:'d_y62',name:'강아지 마당',   icon:'🐶', size:{w:4,h:3}, priceAdj:0, cat:'yard', rarity:'epic',   reqLv:1, pen:true},
    {id:'d_y63',name:'놀이터',        icon:'🛝', size:{w:4,h:4}, priceAdj:0, cat:'yard', rarity:'legend', reqLv:1},
    {id:'d_y64',name:'과수원',        icon:'🍎', size:{w:4,h:4}, priceAdj:0, cat:'yard', rarity:'legend', reqLv:1},
    {id:'d_y65',name:'자갈길 조각',   icon:'🪨', size:{w:3,h:1}, priceAdj:0, cat:'yard', rarity:'common', reqLv:1},
    // ── 집 안 (indoor) ──
    // ⚪ 일반 Lv1+
