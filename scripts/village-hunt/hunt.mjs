...
const PASS = { 포갬쌍: 0.5, 오래포갬ms: 1000, 오래포갬프레임: 20, 우표: 0.4, 프레임ms: FPS > 0 ? Math.round(1000 / FPS * 1.3) : 20, 한칸박자: 0.5 };   /* 포갬 FAIL 은 '오래 포갬'(같은 둘이 1초 넘게 0.6 안) — 평균은 스쳐 지나감이 대부분이라 주의로만(09-23 · mountain 320쌍 중 317쌍이 0.3초 안) */
