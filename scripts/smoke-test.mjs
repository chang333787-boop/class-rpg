...
for (const f of HTML_FILES) {
  ...
  const jsVer = { 'student.js': '20260910a', 'admin.js': '20260910d', 'kiosk.js': '20260713c' }[js];
  ...
  if (html.includes('gamedata.js?v=20260909a')) add('PASS', `${f}: gamedata.js?v=20260909a 캐시버스터`);
