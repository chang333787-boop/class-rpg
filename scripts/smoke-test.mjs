...
// ── 2) 로컬 HTTP 서버 smoke (운영 아님, 로컬 파일만, random free port, 종료 시 close) ──
{
  ...
  const urls = [
    ...
    '/gamedata.js?v=20260907d',
    '/curriculum.js?v=20260903a', '/curriculum_review.js?v=20260903a', '/figures.js?v=20260903a',
    '/student.js?v=20260907b', '/admin.js?v=20260903b', '/kiosk.js?v=20260713c',
...
for (const f of HTML_FILES) {
  ...
  const jsVer = { 'student.js': '20260907b', 'admin.js': '20260903b', 'kiosk.js': '20260713c' }[js];
  ...
  if (html.includes('gamedata.js?v=20260907d')) add('PASS', `${f}: gamedata.js?v=20260907d 캐시버스터`);
