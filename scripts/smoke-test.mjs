...
// ── 2) 로컬 HTTP 서버 smoke (운영 아님, 로컬 파일만, random free port, 종료 시 close) ──
{
  ...
  const urls = [
    ...
    '/curriculum.js?v=20260909c', '/curriculum_review.js?v=20260907q', '/figures.js?v=20260903a',
    '/student.js?v=20260909e', '/admin.js?v=20260903b', '/kiosk.js?v=20260713c',
...
for (const f of HTML_FILES) {
  ...
  const cssVer = { 'student.css': '20260907f', 'admin.css': '20260904k', 'kiosk.css': '20260604' }[cssName];
  ...
  const jsVer = { 'student.js': '20260909e', 'admin.js': '20260903b', 'kiosk.js': '20260713c' }[js];
  ...
  if (html.includes('gamedata.js?v=20260907j')) add('PASS', `${f}: gamedata.js?v=20260907j 캐시버스터`);
