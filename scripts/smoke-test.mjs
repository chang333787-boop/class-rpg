...
// ── 2) 로컬 HTTP 서버 smoke (운영 아님, 로컬 파일만, random free port, 종료 시 close) ──
{
  ...
  const urls = [
    ...
    '/curriculum.js?v=20260731b',
    '/student.js?v=20260731b', '/admin.js?v=20260713h', '/kiosk.js?v=20260713c',
...
for (const f of HTML_FILES) {
  ...
  const jsVer = { 'student.js': '20260731b', 'admin.js': '20260713h', 'kiosk.js': '20260713c' }[js];
