...
// ── 2) 로컬 HTTP 서버 smoke (운영 아님, 로컬 파일만, random free port, 종료 시 close) ──
{
  ...
  const urls = [
    ...
    '/gamedata.js?v=20260907i',
    '/curriculum.js?v=20260903a', '/curriculum_review.js?v=20260903a', '/figures.js?v=20260903a',
    '/student.js?v=20260907e', '/admin.js?v=20260903b', '/kiosk.js?v=20260713c',
...
for (const f of HTML_FILES) {
  ...
  const cssVer = { 'student.css': '20260903b', 'admin.css': '20260904k', 'kiosk.css': '20260604' }[cssName];
  ...
  const jsVer = { 'student.js': '20260907e', 'admin.js': '20260903b', 'kiosk.js': '20260713c' }[js];
  ...
  if (html.includes('gamedata.js?v=20260907i')) add('PASS', `${f}: gamedata.js?v=20260907i 캐시버스터`);
